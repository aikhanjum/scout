...
import type { Rules, Scan, ScoutEvent, Spaces, Telem } from './protocol';
...
interface State {
  ...
  scan: Scan | null;     // last whole rotation (2 Hz). null until a lidar is connected.
...
export const useStore = create<State>((set) => ({
  ...
  link: 'down', detail: '', telem: null, scan: null, events: [], scale: 1,
